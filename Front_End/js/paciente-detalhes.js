(function() {
    ...
    function criarPaginacao(totalItens) {
        ...
        // Se tiver 5 ou menos itens, não mostrar paginação
        if (totalPaginas <= 1) {
            return;
        }
    ...
    // Função para filtrar vacinações por nome da vacina
    ...
    // Função para renderizar a tabela de vacinações com paginação
